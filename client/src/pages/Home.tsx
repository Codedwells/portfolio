		...
		<>
			<section className='flex items-center justify-center flex-col-reverse lg:flex-row  md:space-x-12'>
				<div className='flex flex-col text-[#e2e8f0] mt-8 md:px-12 md:mt-20 lg:mt-28 lg:pl-0 md:text-center lg:text-left'>
					<p className='font-[700] max-w-[400px] px-4 md:px-0 text-left text-[3rem] md:text-center lg:text-left  md:text-[4rem] md:max-w-[800px] lg:max-w-[500px] whitespace-normal leading-[4rem]'>
						...
						<span className='text-[#0a8879] rounded-lg'>visiting</span>{' '}
						👋.&nbsp; I'm Abel.
					</p>
					...
					<Typed color={'#e2e8f0'} seque={'stack'} />
					<div className='flex flex-wrap gap-4 mt-4 pl-4 lg:pr-0 md:pl-0 md:justify-center lg:justify-start'>
						<a
							className=' p-2 md:p-3 rounded-full border-2 border-transparent hover:border-[#14b7a5] active:border-slate-500 transition-all duration-500'
						...
						<a
							className=' p-2 md:p-[8px] rounded-full border-2 border-transparent hover:border-[#14b7a5] active:border-slate-500 transition-all duration-500'
			...
			<div className='overflow-x-hidden'>
				<article className='relative w-full mt-20 mb-14 md:mb-[7rem] md:mt-16  py-10 pb-[4rem] lg:mt-[9.6rem] md:px-14 lg:px-[17rem] md:text-center before:block before:absolute before:-inset-2 md:before:-inset-8 before:skew-y-[4deg] before:bg-gradient-to-r before:from-[#1a3d5b] before:to-[#0f172a]'>
					<div className='relative'>
						<h2 className='text-[2.4rem] px-6  text-[#e2e8f0] font-[700] md:text-[3rem] md:text-center'>
							My story
						</h2>
						<p className='text-left mt-2 px-[1.4rem] md:text-center font-Poppins font-[400] md:text-[1.2em] text-[#e2e8f0] md:px-14 '>
			...
			<section className='md:mt-[10rem]  '>
				<div className='md:mx-12 lg:mx-[20rem]'>
					<h2 className='text-[#e2e8f0] pl-4 md:pl-0 text-[2.4rem] font-[700] md:text-[3rem] md:text-center'>
						My tools
					</h2>

					<div className='grid gap-4 grid-cols-3 place-items-center text-[#718497] font-[500]  md:grid-cols-4  p-4 mt-8'>
						...
						<div
							ref={resumeRef}
							className='flex flex-col p-1  items-center border-[#1e293b] border-2 rounded-md w-[100px]'
						>
					...
					<p className='mt-[3rem] font-Raleway text-[#e2e8f0] font-[500] text-2xl text-center'>
						Download resume{' '}
						<a
				...
				<h2 className='text-[2.4rem] mt-[6rem] px-6 text-[#e2e8f0] font-[700] md:text-[3rem] md:text-center'>
					Projects
				</h2>
				<p className='px-[1.5rem] md:text-center font-[500] text-2xl mt-4 text-[#e2e8f0] font-Raleway'>
			...
			>
				<div className=' flex flex-col items-center lg:w-[40%] p-1'>
					<p className='font-[700] w-full px-3 text-4xl md:text-center lg:text-left lg:text-5xl text-[#e2e8f0]'>
						Contact me
					</p>
					<p className='mt-[1.2rem] px-4 md:px-0 md:text-center lg:text-left lg:font-[500] md:text-xl text-[#e2e8f0] md:max-w-[42rem] lg:max-w-[36rem]'>
					...
					<form action='' className='flex flex-col space-y-4'>
						<div className='flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:space-x-4 '>
							<input
								...
								value={formData.name}
								required
								className='h-[3rem]  p-2 text-[#8796ab] font-[600] placeholder:opacity-50 bg-[#1e293b] rounded rounded-l-none focus:outline-none border-l-[3px] border-transparent focus:border-l-blue-500 '
							/>
							<input
								onChange={setForm}
								autoComplete='false'
						...
						<textarea
							...
							required
							className='p-2 text-[#8796ab] font-[600] placeholder:opacity-50 bg-[#1e293b] rounded rounded-l-none focus:outline-none border-l-[3px] border-transparent  focus:border-l-blue-500 '
						/>

						<div className='mx-auto '>
							<button
								onClick={sendMessage}
								className='text-white font-Raleway bg-[#0a8879] hover:ring-4 hover:ring-teal-500 hover:bg-teal-700 active:ring-0 font-[600] rounded-lg text-lg  px-5 py-2.5 text-center mr-2 mb-2 w-[16rem]'
							>
								Submit
							</button>
						</div>
