	...
	return (
		<>
			<section className='flex items-center justify-center flex-col-reverse lg:flex-row  md:space-x-12'>
				<div className='flex flex-col mt-8 md:pl-20 md:mt-20 lg:pl-0'>
					<p className='font-[700] px-4 md:px-0 text-left text-[3rem]  md:text-[4rem] max-w-[500px] whitespace-normal leading-[4rem]'>
